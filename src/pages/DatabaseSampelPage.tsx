  ...
  const handleSubmitSample = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingSample?.id) {
        ...
        await createSample(
          payload,
          isEmployee ? false : sampleFormData.autoCreateExpense,
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {showAddChooser && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
                <div className="w-full max-w-md rounded-3xl bg-white p-6 text-zinc-900 shadow-2xl border border-zinc-200 space-y-4 animate-in fade-in zoom-in duration-150">
